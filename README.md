...
# (par damya) je me charge du "gamme over", c'est a dire que le jeu s'arrette lorsque le serpent touche un mur ou lorsque sa tete entre en collision avec son propre corps avec la fonction fen.destroy(). On peut voir au debut du code que j'ai ajouté la fonction intersect pour facilité l'appel des coordonées du serpent et des murs.
